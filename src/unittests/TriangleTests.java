...
public class TriangleTests {
    ...
    public void TriangleIntersectionPointsTest() throws Exception {
            ...
            Triangle triangle = new Triangle(new Point3D(0, 1, -2),new Point3D(1, -1, -2),new Point3D(-1, -1, -2), new Color(0,0,0), new Material(1,1,1,0,0));
            Triangle triangle2 = new Triangle(new Point3D(0, 10, -2),new Point3D(1, -1, -2),new Point3D(-1, -1, -2), new Color(0,0,0), new Material(1,1,1,0,0));
            ...
            Triangle triangle3 = new Triangle(new Point3D(3, 3, -1), new Point3D(2, 0, -1),new Point3D(4, 0, -1), new Color(0,0,0), new Material(1,1,1,0,0));
            // special case test: one ray is encompassed in triangle so i expect ZERO intersection points
            Triangle triangle4 = new Triangle(new Point3D(0, 0, -1), new Point3D(2, 0, -2),new Point3D(-2, 0, -2), new Color(0,0,0), new Material(1,1,1,0,0));
