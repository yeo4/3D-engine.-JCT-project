...
public class EllipsoidTests {
	...
	public void testIntersectionPoints() throws Exception {
	  ...
	  Ellipsoid ellipsoid = new Ellipsoid(new Point3D(0.0, 0.0, 0.0), 1, 2, 3, new Color(0,0,0));
	  Ellipsoid ellipsoid2 = new Ellipsoid(new Point3D(0.0, 0.0, -4), 1, 2, 3, new Color(0,0,0));
	  //Special Case Test: Tangent Line
	  Ellipsoid ellipsoid3 = new Ellipsoid(new Point3D(1, 0.0, -6), 1, 2, 3, new Color(0,0,0));
	  
	  Ellipsoid ellipsoid4 = new Ellipsoid(new Point3D(6, 0.0, -8), 5, 2, 3, new Color(0,0,0));
